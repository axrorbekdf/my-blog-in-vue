<template>
    <main class="d-flex justify-content-center text-center mt-84" style="margin-top: 20vh;">
        <form style="width: 300px;">
            ...
            <div class="form-floating mb-2">
                <input type="password" class="form-control" id="floatingPassword" placeholder="Parol">
                <label for="floatingPassword">Parol</label>
            </div>
            
            <button class="btn btn-primary w-100 py-2 mt-2" type="submit">Ro'yxatdan o'tish</button>
